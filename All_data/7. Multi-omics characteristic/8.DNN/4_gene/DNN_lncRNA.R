...
write.csv(deg_gene,file = "./DNN_alldeg_lncRNA.csv")
deg_100 <- head(deg_gene,100)
write.csv(deg_100,file = "./DNN_100deg_mRNA.csv")

data <- TCGA

DNN_100lncRNA_expr <- data[rownames(deg_100),]
DNN_100lncRNA_expr <- t(DNN_100lncRNA_expr)
DNN_100lncRNA_expr <- as.matrix(DNN_100lncRNA_expr)
save(DNN_100lncRNA_expr,file = "./DNN_100lncRNA_expr.rda")
