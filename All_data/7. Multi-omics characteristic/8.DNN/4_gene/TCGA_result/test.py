...
labels = pd.read_csv('./test_pd.csv')
labels = labels['RS']
labels = np.array(labels)
gene_expression_matrix = pd.read_csv('test_data.csv',index_col=0)
...
set_seed(33)
lnc_expression_matrix = pd.read_csv('test_lncdata.csv',index_col=0)
...
set_seed(44)
meth_expression_matrix = pd.read_csv('test_methydata.csv',index_col=0)
...
set_seed(5555)
mi_expression_matrix = pd.read_csv('test_midata.csv',index_col=0)
