...
labels = pd.read_csv('./train_pd.csv')
labels = labels['RS']
labels = np.array(labels)

gene_expression_matrix = pd.read_csv('train_data.csv',index_col=0)
...
set_seed(3)
lnc_expression_matrix = pd.read_csv('train_lncdata.csv',index_col=0)
...
set_seed(432)
meth_expression_matrix = pd.read_csv('train_methydata.csv',index_col=0)
...
set_seed(5)
mi_expression_matrix = pd.read_csv('train_midata.csv',index_col=0)
